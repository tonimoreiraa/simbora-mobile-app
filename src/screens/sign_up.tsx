...
import { Text, TouchableOpacity, View, SafeAreaView, Animated, Easing } from 'react-native';
    ...
    <SafeAreaView style={tw`bg-white`}>
      <View
        ...
        <Animated.View 
          ...
          <Animated.Text style={[tw`text-stone-500 text-center mb-1 mt-5`, { opacity: fadeAnim }]}>
            Crie sua conta gratuitamente
          </Animated.Text>
          <Animated.Text style={[tw`text-xl font-bold text-center px-4`, { opacity: fadeAnim }]}>
        ...
        <Animated.View style={[tw`w-full`, { opacity: formAnim }]}>
          ...
          <View style={tw`w-full`}>
            ...
            <Animated.View style={[tw`w-full`, { opacity: buttonsAnim }]}>
              <Animated.View style={{ transform: [{ scale: createAccountBtnScale }] }}>
                <TouchableOpacity
