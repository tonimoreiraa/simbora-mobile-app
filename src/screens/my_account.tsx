        ...
        <View>
            <ScrollView>
                <View style={tw`flex flex-col items-center justify-center px-4 mt-6 h-full w-full`}>
                    ...
                    <View style={tw`flex flex-row items-center justify-between bg-gray-100 w-full p-4 mt-4`}>
                        <View style={tw`flex flex-row items-center justify-center`}>
                            <View style={tw`w-14 h-14 bg-gray-200 rounded-lg`}></View>
                            <View style={tw`ml-4`}>
                    ...
                    <View style={tw`w-full mt-8`}>
                        ...
                        <TextInput style={tw`bg-gray-100 rounded p-4 mt-4`} placeholder="@erivaldocavalcante"></TextInput>
                    </View>
