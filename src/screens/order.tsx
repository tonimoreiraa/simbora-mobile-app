            ...
            <ScrollView>
                <View style={tw`flex flex-col items-center justify-center px-4 mt-6 h-full w-full`}>
                    ...
                    <View style={tw` mt-6 w-full mb-36`}>
                        ...
                        <TextInput style={tw`bg-stone-100 rounded p-4 mt-4`} placeholder="Digite o ID do profissional"></TextInput>
                        <TextInput style={tw`bg-stone-100 rounded p-4 mt-4`} placeholder="Número do cartão"></TextInput>
                        <TextInput style={tw`bg-stone-100 rounded p-4 mt-4`} placeholder="Nome do titular"></TextInput>
                    </View>
                </View>
            </ScrollView>
