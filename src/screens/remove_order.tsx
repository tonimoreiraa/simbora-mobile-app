...
export default function RemoveOrder() {
  ...
  return (
    <SafeAreaView>
      <ScrollView>
        <View style={tw`flex w-full px-4 bg-white mt-5`}>
          <View style={tw`flex items-center justify-center w-full py-6`}>
            <Text style={tw`text-center font-medium text-base`}>
              Apresente o QR Code abaixo no balcão de retirada e um documento
              com foto para realizar a retirada doe seu pedido.
            </Text>
          ...
          <View>
            <View style={tw`w-full`}>
              ...
              <Text style={tw`text-xs text-stone-400 mb-0.5`}>ID do pedido</Text>
