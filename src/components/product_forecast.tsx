      ...
      case 'em rota':
        return (
          ...
          >
            ...
            <CaretRight size={20} color={tw.color('gray-700')} weight="regular" />
          </TouchableOpacity>
        );
      case 'delivered':
      case 'entregue':
  ...
  return (
    <View style={tw`bg-gray-50 rounded-2xl p-5 mb-4 shadow-sm`}>
      <View style={tw`flex-row items-start`}>
        <View style={tw`bg-gray-200 rounded-2xl w-20 h-20 items-center justify-center mr-4`}>
          <IconComponent
            weight="fill"
            size={48}
            color="#000000"
        ...
        <View style={tw`flex-1`}>
          <Text style={tw`text-lg font-medium text-gray-900 mb-1`}>
            Pedido
          </Text>
          ...
          <View style={tw`flex-row items-center`}>
            <View style={tw`${statusStyle.bgColor} ${statusStyle.borderColor} border px-4 py-2 rounded-full flex-row items-center`}>
              <statusStyle.icon 
                size={16} 
