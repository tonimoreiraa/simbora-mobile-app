...
export const getPostProductsMutationOptions = <
  TError = ErrorType<void | PostProducts422>,
  TContext = unknown,
>(options?: {
...
export type PostProductsMutationError = ErrorType<void | PostProducts422>;
...
export const getGetProductsIdQueryOptions = <
  ...
  TError = ErrorType<GetProductsId404>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
...
export type GetProductsIdQueryResult = NonNullable<
  Awaited<ReturnType<typeof getProductsId>>
>;
export type GetProductsIdQueryError = ErrorType<GetProductsId404>;
...
export type PutProductsIdMutationError = ErrorType<void>;
...
export const getPostProductsAddPhotoMutationOptions = <
  TError = ErrorType<PostProductsAddPhoto400 | void>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PostProductsAddPhotoMutationError =
  ErrorType<PostProductsAddPhoto400 | void>;
