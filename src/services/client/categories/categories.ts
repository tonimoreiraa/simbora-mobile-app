...
export const getGetCategoriesQueryOptions = <TData = Awaited<ReturnType<typeof getCategories>>, TError = ErrorType<unknown>>(params?: GetCategoriesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCategories>>, TError, TData>, request?: SecondParameter<typeof axiosInstance>}
) => {
...
export function useGetCategories<TData = Awaited<ReturnType<typeof getCategories>>, TError = ErrorType<unknown>>(
 params?: GetCategoriesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCategories>>, TError, TData>, request?: SecondParameter<typeof axiosInstance>}
...
export const getPostCategoriesMutationOptions = <TError = ErrorType<PostCategories400 | PostCategories404>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postCategories>>, TError,{data: BodyType<PostCategoriesBody>}, TContext>, request?: SecondParameter<typeof axiosInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof postCategories>>, TError,{data: BodyType<PostCategoriesBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postCategories>>, {data: BodyType<PostCategoriesBody>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostCategoriesMutationError = ErrorType<PostCategories400 | PostCategories404>

    /**
 * @summary Criar nova categoria
 */
export const usePostCategories = <TError = ErrorType<PostCategories400 | PostCategories404>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postCategories>>, TError,{data: BodyType<PostCategoriesBody>}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 ): UseMutationResult<
...
export const getGetCategoriesIdQueryOptions = <TData = Awaited<ReturnType<typeof getCategoriesId>>, TError = ErrorType<GetCategoriesId404>>(id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCategoriesId>>, TError, TData>, request?: SecondParameter<typeof axiosInstance>}
) => {
...
export function useGetCategoriesId<TData = Awaited<ReturnType<typeof getCategoriesId>>, TError = ErrorType<GetCategoriesId404>>(
 id: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getCategoriesId>>, TError, TData>, request?: SecondParameter<typeof axiosInstance>}
...
export const getPutCategoriesIdMutationOptions = <TError = ErrorType<PutCategoriesId400 | PutCategoriesId404>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putCategoriesId>>, TError,{id: number;data: BodyType<PutCategoriesIdBody>}, TContext>, request?: SecondParameter<typeof axiosInstance>}
): UseMutationOptions<Awaited<ReturnType<typeof putCategoriesId>>, TError,{id: number;data: BodyType<PutCategoriesIdBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof putCategoriesId>>, {id: number;data: BodyType<PutCategoriesIdBody>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PutCategoriesIdMutationError = ErrorType<PutCategoriesId400 | PutCategoriesId404>

    /**
 * @summary Atualizar categoria
 */
export const usePutCategoriesId = <TError = ErrorType<PutCategoriesId400 | PutCategoriesId404>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putCategoriesId>>, TError,{id: number;data: BodyType<PutCategoriesIdBody>}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 ): UseMutationResult<
...
export const getDeleteCategoriesIdMutationOptions = <TError = ErrorType<DeleteCategoriesId404>,
 ...
 * @summary Deletar categoria
 */
export const useDeleteCategoriesId = <TError = ErrorType<DeleteCategoriesId404>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteCategoriesId>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof axiosInstance>}
 ): UseMutationResult<
